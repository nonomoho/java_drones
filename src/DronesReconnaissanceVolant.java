...
public class DronesReconnaissanceVolant extends DronesVolants {
    public DronesReconnaissanceVolant(String nom, int vitesse, double consommation, double batterie, double charge, int distanceMax, Point position, Colis colis, boolean enVol) {
