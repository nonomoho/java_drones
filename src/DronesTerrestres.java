...
abstract public class DronesTerrestres extends Drones{
    ...
    public DronesTerrestres(String nom, int vitesse, double consommation, double batterie, double charge, int distanceMax, Point position, Point destination, Colis colis, int instruction) {
