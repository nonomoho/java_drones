...
abstract public class DronesVolants extends Drones{
    ...
    public DronesVolants(String nom, int vitesse, double consommation, double batterie, double charge, int distanceMax, Point position, Point destination, Colis colis, Instruction instruction, boolean enVol) {
